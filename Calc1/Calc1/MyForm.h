...
namespace Calc1 {
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		// Calculation of the monthly loan payment in case of correct data entry
		if (k == 0) 
		{
	...
	// Functions for checking the entered data for correctness
	...
	// Final calculation of the amount
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		double year; // Number of days in a year in which the contribution is made

		if (b == 0) 
		{
			// Final calculation of the deposit amount
			...
			int summ_vklad = (int)h; // Rounding a number
